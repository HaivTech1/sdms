                        ...
                        <div class='panel-body'>
                            <div class='parent'>
                                <div class='col-xs-2 col-sm-2 col-md-2 text-center'>
                                    <img class='img-rounded img-responsive' src='{{  asset('storage/'.$student->image()) }}' alt='{{ $student->firstName()}}'/>
                                </div>
                                ...
                                <div class='col-xs-2 col-sm-2 col-md-2 text-center text-responsive'> 
                                    <img src='{{  asset('storage/'.$student->image()) }}' class='img-rounded img-responsive' alt='logo' />
                                </div>
                            </div>
                            <hr />

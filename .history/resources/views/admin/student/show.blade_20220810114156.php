                    ...
                    <div class='panel panel-primary'>
                        ...
                        <div style="flex: 1">
                            ...
                            <div style="margin-top: 15px">
                                <blockquote><b style="margin-bottom: 5px">Allergics</b> {{ $student->allergics()}}<blockquote>

                                <blockquote style="margin-top: 15px"><b>Medical Health Condition:</b> {{ $student->medical()}}</blockquote>
                            </div>
                        </div>

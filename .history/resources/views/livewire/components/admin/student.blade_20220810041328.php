                                    ...
                                    <tbody>
                                        @foreach ($subjects as $key => $subject)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript: void(0);"
                                                        class="text-body fw-bold">{{ $subject->title() }}</a>
                                                </td>
                                                <td>
                            ...
                            <form action="{{ route('subject.store') }}" method='post'>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 mt-2">
                                        <x-form.label for='students' value="{{ __('Classes') }}" />
                                        <select name="students[]" class="form-control select2-multiple" multiple>

                                ...
                                <table class="table align-middle table-nowrap table-check">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <livewire:components.edit-title :model='$payment' field='title'
                                                    :key='$payment->id()' />
                                            </td>
                                            <td>
                                                <livewire:components.edit-title :model='$payment' field='price'
                                                    :key='$payment->id()' />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <livewire:components.toggle-button :model='$payment' field='status'
                                                    :key='$payment->id()' />
                                            </td>
                                        </tr>
                                        @endforeach

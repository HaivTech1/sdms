                                    ...
                                    <form action="#" method='post'>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 mt-2">
                                                <x-form.label for='grades' value="{{ __('Select class') }}" />
                                                <select wire:model="grades" class="form-control">
                                            ...
                                            <div class="col-sm-12 mt-2">
                                                <x-form.label for='student' value="{{ __('Classes') }}" />
                                                <select name="student" class="form-control">
                                                    <option>Select classes</option>
                                                    @foreach ($students as $student)
                                                    <option value="{{ $student->id() }}">{{ $student->title() }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                                <x-form.error for="students" />
                                            </div>
                                            <div class="col-sm-12 mt-2">

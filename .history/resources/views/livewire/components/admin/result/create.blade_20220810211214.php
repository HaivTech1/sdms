                                        ...
                                        @foreach ($students as $student)
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{ $student->id() }}</td>
                                                    <td>
                                                        <x-form.input style='width: 10px' class="text-center" type='number' wire:model.defer='state.ca1'/>
                                                    </td>
                                                    <td>
                                                        <x-form.input class="text-center" type='number' wire:model.defer='state.ca1'/>
                                                    </td>
                                                    <td>
                                                        <x-form.input class="text-center" type='number' wire:model.defer='state.ca1'/>
                                                    </td>

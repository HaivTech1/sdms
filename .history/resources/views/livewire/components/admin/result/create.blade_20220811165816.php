                                    ...
                                    <table class="table align-middle table-nowrap table-check">
                                        ...
                                        @foreach ($results as $index => $result)
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <livewire:components.edit-title :model='$result' field='ca1' :key='$result' />
                                                    </td>
                                                    <td>
                                                        <livewire:components.edit-title :model='$result' field='ca2' :key='$result' />
                                                    </td>
                                                    <td>
                                                        <livewire:components.edit-title :model='$result' field='ca3' :key='$result' />
                                                    </td>
                                                    <td>
                                                        <livewire:components.edit-title :model='$result' field='exam' :key='$result' />
                                                    </td>
                                                    <td>

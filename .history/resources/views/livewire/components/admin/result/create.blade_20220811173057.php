                                    ...
                                    <table class="table align-middle table-nowrap table-check">
                                        ...
                                        @foreach ($results as $index => $result)
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <livewire:components.edit-title :model='$result' field='ca1' wire:key='$result->id()' />
                                                    </td>
                                                    <td>
                                                        <livewire:components.edit-title :model='$result' field='ca2' wire:key='$result->id()' />
                                                    </td>
                                                    <td>
                                                        <livewire:components.edit-title :model='$result' field='ca3' wire:key='$result->id()' />
                                                    </td>
                                                    <td>

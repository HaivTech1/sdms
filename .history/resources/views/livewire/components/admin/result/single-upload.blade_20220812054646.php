                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-3">
                                <x-form.input class="text-center" type='text'  list="datalistOptions"
                                         value="{{ $student_id }}" wire:model.debounce.1000ms="student_id" placeholder="Type to search student..." />
                                    <datalist id="datalistOptions">
                                        @foreach ($students as $student)
                                            <option value="{{  $student->firstName() }} {{  $student->firstName() }}">
                                        @endforeach
                                    </datalist>
                            </div>
                        ...
                        @if ($student_id)
                            <div class='col-sm-12'>
                                <form action="{{ route('result.store') }}" method="POST">
                                    ...
                                    <x-form.input style='width: 50px' class="text-center" type='text'
                                    ...
                                    <x-form.input style='width: 50px' class="text-center" type='text'
                                        name='student_id' value="{{  $selectedStudent }}" autofocus />

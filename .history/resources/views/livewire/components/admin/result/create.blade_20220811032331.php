                                        ...
                                        @foreach ($students as $index => $student)
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <x-form.input style='width: 50px'  class="text-center" type='text' name='student_id' value="{{ old('student_id', $student->id()) }}"  autofocus />
                                                        <x-form.input style='width: 50px'  class="text-center" type='text' name='period_id' value="{{ old('period_id', $period->id()) }}"  autofocus />
                                                        <x-form.input style='width: 50px'  class="text-center" type='text' name='term_id' value="{{ old('term_id', $term->id()) }}"  autofocus />
                                                        <x-form.input style='width: 50px'  class="text-center" type='text' name='subject_id' value="{{ old('subject_id', $subject->id()) }}"  autofocus />
                                                        <x-form.input style='width: 50px'  class="text-center" type='text' name='grade_id' value="{{ old('student_id', $student->id()) }}"  autofocus />

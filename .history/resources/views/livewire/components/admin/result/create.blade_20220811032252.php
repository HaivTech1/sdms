                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <x-form.input style='width: 50px'  class="text-center" type='text' name='period_id' value="{{ old('student_id', $student->id()) }}"  autofocus />
                                                        <x-form.input style='width: 50px'  class="text-center" type='text' name='student_id' value="{{ old('student_id', $student->id()) }}"  autofocus />
                                                        <x-form.input style='width: 50px'  class="text-center" type='text' name='subject_id' value="{{ old('student_id', $student->id()) }}"  autofocus />

                                    ...
                                    @foreach ($results as $index => $result)
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <livewire:components.edit-title :model='$result' field='ca2'
                                                        :key='$index' />
                                                    {{-- <x-form.input style='width: 50px'  class="text-center" type='number' name='ca2[]' value="{{ $result->secondCA() }}"
                                                    autofocus /> --}}
                                                </td>
                                                <td>
                                                    <livewire:components.edit-title :model='$result' field='ca3'
                                                        :key='$index' />
                                                    {{-- <x-form.input style='width: 50px'  class="text-center" type='number' name='ca3[]' value="{{ $result->thirdCA() }}"
                                                    autofocus /> --}}
                                                </td>
                                                <td>
                                                    {{-- <x-form.input style='width: 50px'  class="text-center" type='number' name='exam[]' value="{{ $result->exam() }}"
                                                    autofocus /> --}}
                                                    <livewire:components.edit-title :model='$result' field='exam'
                                                        :key='$index' />
                                                </td>
                                                <td>

...
class Create extends Component
{
    ...
    {
        return Result::where('period_id', $this->selectedPeriod)->where('term_id', $this->selectedTerm)->where('grade_id', $this->selectedGrade)->where('subject_id', $this->selectedSubject)->get();        
    }

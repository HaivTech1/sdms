...
class Create extends Component
{
    ...
    {
        return Result::when('period_id', $this->period_id)->where('term_id', $this->selectedTerm)->where('grade_id', $this->selectedGrade)->where('subject_id', $this->selectedSubject)->get();        
    }

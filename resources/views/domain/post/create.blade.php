                    ...
                    <form action="{{ route('post.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-form.input id="title" class="block w-full mt-1" type="text" name="title"
                                            id="title" placeholder="Post Title" :value="old('title')" autofocus />
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-form.input name="photo_credit_text" id="photo_credit_text"
                                            class="block w-full mt-1" type="text" :value="old('photo_credit_text')" />
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <x-form.input name="photo_credit_link" id="photo_credit_link"
                                            class="block w-full mt-1" type="text" :value="old('photo_credit_link')" />
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-3">
                                ...
                                <span class="text-bold font-semibold text-primary uppercase">Disable
                                    Comments</span>

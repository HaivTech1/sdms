<x-base-layout>
    ...
    <section class="slider_area slider-active">
        <div class="single_slider bg_cover d-flex align-items-center" style="background-image: url({{ asset('frontend/images/slider-1.jpg') }})">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="slider_content text-center">
                            <h4 class="sub_title" data-animation="fadeInUp" data-delay="0.2s">Welcome to </h4>
                            <h2 class="main_title" data-animation="fadeInUp" data-delay="0.5s">{{ application('name') }}</h2>
                            <p data-animation="fadeInUp" data-delay="0.8s">{{ application('slogan') }}</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about_image mt-50">
                        <img src="{{ asset('frontend/images/about-1.jpg') }}" alt="about" class="about_image-1">
                        <img src="{{ asset('frontend/images/about-2.jpg') }}" alt="about" class="about_image-2">
                        <img src="{{ asset('frontend/images/about-3.jpg') }}" alt="about" class="about_image-3">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row counter_wrapper">
                ...
                <div class="col-lg-3 col-sm-6 counter_col">
                    <div class="single_counter text-center mt-50">
                        <div class="counter_icon">
                            <div class="icon_wrapper">
                                <img src="{{ asset('frontend/images/count_icon-3.png') }}" alt="Icon">
                            </div>
                        </div>
                        <div class="counter_content">
    ...
    <section class="about_area_2 d-flex flex-wrap ">
        <div class="about_video bg_cover" style="background-image: url({{ asset('frontend/images/about_bg.jpg') }})">
            <div class="video">
        ...
        <div class="about_content_2">
            <div class="single_about_2 d-flex flex-wrap">
                ...
                <div class="about_2_image bg_cover" style="background-image: url({{ asset('frontend/images/about-4.jpg') }})"></div>
            </div>
            ...
            <div class="single_about_2 d-flex flex-wrap">
                ...
                <div class="about_2_image bg_cover order-md-first" style="background-image: url({{ asset('frontend/images/about-5.jpg') }})"></div>
            </div>
        </div>
    </section>
            ...
            <div class="row no-gutters program_wrapper">
                <div class="col-lg-4 col-md-6 program_col">
                    <div class="single_program program_color-1 d-flex flex-wrap">
                        <div class="program_icon">
                            <div class="icon_wrapper">
                                <img src="{{ asset('frontend/images/p-icon-1.png') }}" alt="Icon">
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 program_col">
                    <div class="single_program program_color-2 d-flex flex-wrap program_4">
                        <div class="program_icon">
                            <div class="icon_wrapper">
                                <img src="{{ asset('frontend/images/p-icon-2.png') }}" alt="Icon">
                            </div>
                        </div>
                        <div class="program_content">
                            <div class="content_wrapper">
                ...
                <div class="col-lg-4 col-md-6 program_col">
                    <div class="single_program program_color-3 d-flex flex-wrap program_3">
                        <div class="program_icon">
                            <div class="icon_wrapper">
                                <img src="{{ asset('frontend/images/p-icon-3.png') }}" alt="Icon">
                            </div>
                        </div>
                        <div class="program_content">
                            <div class="content_wrapper">
                ...
                <div class="col-lg-4 col-md-6 program_col">
                    <div class="single_program program_color-4 d-flex flex-wrap program_2 program_3 program_4">
                        <div class="program_icon">
                            <div class="icon_wrapper">
                                <img src="{{ asset('frontend/images/p-icon-4.png') }}" alt="Icon">
                            </div>
                        </div>
                        <div class="program_content">
                            <div class="content_wrapper">
                ...
                <div class="col-lg-4 col-md-6 program_col">
                    <div class="single_program program_color-5 d-flex flex-wrap program_2">
                        <div class="program_icon">
                            <div class="icon_wrapper">
                                <img src="{{ asset('frontend/images/p-icon-5.png') }}" alt="Icon">
                            </div>
                        </div>
                        <div class="program_content">
                            <div class="content_wrapper">
                ...
                <div class="col-lg-4 col-md-6 program_col">
                    <div class="single_program program_color-6 d-flex flex-wrap program_2 program_4">
                        <div class="program_icon">
                            <div class="icon_wrapper">
                                <img src="{{ asset('frontend/images/p-icon-6.png') }}" alt="Icon">
                            </div>
                        </div>
                        <div class="program_content">
                            <div class="content_wrapper">
    ...
    <section class="courses_area courses_bg pt-120 pb-130">
        ...
        <img class="shape-1" src="{{ asset('frontend/images/shape/shape-1.png') }}" alt="shape">
        <img class="shape-2" src="{{ asset('frontend/images/shape/shape-2.png') }}" alt="shape">
        <img class="shape-3" src="{{ asset('frontend/images/shape/shape-3.png') }}" alt="shape">
        <img class="shape-4" src="{{ asset('frontend/images/shape/shape-4.png') }}" alt="shape">
        <img class="shape-5" src="{{ asset('frontend/images/shape/shape-5.png') }}" alt="shape">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_courses mt-30">
                        <div class="courses_image">
                            <img src="{{ asset('frontend/images/courses-1.jpg') }}" alt="courses">
                        </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_courses mt-30">
                        <div class="courses_image">
                            <img src="{{ asset('frontend/images/courses-2.jpg') }}" alt="courses">
                        </div>
                        <div class="courses_content">
                            <ul class="tag">
                            ...
                            <div class="courses_author d-flex">
                                <div class="author_image">
                                    <img src="{{ asset('frontend/images/author-2.jpg') }}" alt="author">
                                </div>
                                <div class="author_name media-body">
    ...
    <section class="testimonial_area pt-80 pb-130 bg_cover" style="background-image: url({{ asset('frontend/images/testimonial_bg.jpg')}})">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="testimonial_title mt-50">
                        <img src="{{ asset('frontend/images/quota.png') }}" alt="quota">
    ...
    <section class="events_area d-flex flex-wrap">
        <div class="events_left">
            <div class="single_events d-flex flex-wrap">
                <div class="events_content bg_cover" style="background-image: url({{ asset('frontend/images/team-4.jpg') }})">
            ...
            <div class="single_events d-flex flex-wrap">
                <div class="events_content events_content_2 bg_cover" style="background-image: url({{ asset('frontend/images/team-4.jpg') }})">
                    <div class="events_wrapper">
                        <ul class="events_meta">
                            <li><a class="color-1" href="#"><i class="fa fa-calendar"></i> 09 Dec, 2019</a></li>
                            <li><a class="color-2" href="#"><i class="fa fa-map-marker"></i>New york grand city 1247</a></li>
        ...
        <div class="events_right bg_cover" style="background-image: url({{ asset('frontend/images/event-3.jpg') }})">

...
<head>
    ...
    @section('title', $grade->title . " | Class Mid Term Result Report")
    <style>
        @font-face {
          font-family: 'Amiri';
    ...
    @foreach($classData as $index => $studentData)
        ...
        <div id="body_content">
            ...
            <div class="header">
                ...
                <div class="header-item">
                    <img src="{{ public_path('storage/' . $studentData['student']->user->image()) }}" width="100" height="90"
                        alt="{{ $studentData['student']->last_name }}">
                </div>
            </div>
            ...
            <div class="majorContainer">
                <div class="mainContainer">
                    <div class="result-item">
                        <b>Name:</b> <span>{{ ucfirst($studentData['student']->lastName()) }} {{ ucfirst($studentData['student']->firstName()) }}
                            {{ ucfirst($studentData['student']->otherName()) }}</span>
                    </div>
                    <div class="result-item">
                        <b>Admission No.:</b>
                        <span>{{ $studentData['student']->user->code()}}</span>
                    </div>
                    <div class="result-item">
                        <b>Class:</b>
            ...
            <div style="margin: 5px 0" class="page-break">
                <span style="font-weight: bold; font-size: 15px">Remark: </span><span>{{ $studentData['comment'] }}</span>
            </div>
        </div>
    @endforeach
</body>

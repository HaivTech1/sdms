<x-app-layout>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div style="border: 1px solid #000; padding: 4px; border-radius: 10px">
                        ...
                        <div class='parent'>
                            ...
                            <div class='col-xs-8 col-sm-8 col-md-8 text-center'>
                                ...
                                <div class="d-flex justify-content-center align-items-center"
                                    style="margin-top: 20px; font-weight: 700; font-size: 20px; text-decoration: uppercase"">
                            ...
                            <div style="margin: 15px 10px">
                                <div class="row">
                                    <ul class="col-sm-4">
                                        <li> <b>Name</b>: {{ ucfirst($student->fullName()) }}
                                        </li>
                                        <li> <b>Gender</b>: {{ ucfirst($student->gender())}} </li>
                                        <li> <b>Class</b>: {{ $student->grade->title()}} </li>
                                        <li> <b>Admission no.</b>:{{ $student->user->code() }}
                                        </li>
                                    </ul>
                                    <ul class="col-sm-4">
                                        <li> <b>Class population</b>: {{ $student->grade->students->count()}}</li>

                                        <li> <b>Mark obtainable</b>: {{ $student->subjects->count() * 100 }}</li>

                                        <li> <b>Mark obtained</b>: <span class="s-avg grand_total"></span></li>

                                        <li> Aggregate: <span class="s-avg aggregate"></span> </li>

                                    </ul>
                                    <ul class="col-sm-4">
                                        <li> <b>No. of times school opened</b>: {{ $studentAtendance->attendance_duration ?? 0 ?? ''}}
                                                days</li>
                                        <li> <b>No. of times present</b>: {{ $studentAttendance->attendance_present ?? '' }} </li>
                                        <li> <b>Attendance Average</b>: {{ calculatePercentage($studentAttendance->attendance_duration ?? 0, $studentAttendance->attendance_present ?? 0, 100) ?? '' }}%
                                        </li>
                                        <li> <b>Position in class</b>: {!! $position !!}</li>
                                    </ul>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9 cogd">
                                                    ...
                                                    <th style="padding-left: 0.04px; padding-right: 0.04px; padding-bottom: 0; text-align: center; margin-bottom: 0"
                                                        ...
                                                        <table style="" class="table">
                                                            <thead>
                                                                <tr>
                                                                    @foreach ($midterm as $key => $value)
                                                                    <th class="rotate-header">{{ $value['full_name'] }}
                                                                    </th>
                                                                    @endforeach
                                                                    @foreach ($exam as $key => $value)
                                                                    <th class="rotate-header">{{ $value['full_name'] }}
                                                                    ...
                                                                    @endforeach
                                                                    <th class="rotate-header" style="font-size: 12px">
                                                                        Total </th>
                                                                    <th class="rotate-header" style="font-size: 12px">
                                                                        Position </th>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <th>{{ $value['mark'] }}</th>
                                                                    @endforeach
                                                                    <th style="font-size: 12px">{{ $expectedTotal }}
                                                                    </th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    @foreach ($exam as $key => $value)
                                                        @if (isset($result[$key]))
                                                        @php
                                                        $color = ($examTotal == 40) ? exam40Color($result[$key]) :
                                                        exam60Color($result[$key]);
                                                        @endphp
                                                        <td
                                    ...
                                    <div class="row mt-2 mb-2">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="table-responsive">
                                                <p class="comment" style="font-size: 8px;">

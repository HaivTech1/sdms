...
Route::group(['prefix' => 'v1'], function () {
    ...
    Route::group(['middleware' => 'auth:sanctum'], function () {
        ...
        Route::group(['prefix' => 'student', 'namespace' => 'Student'], function () {
            ...
            Route::put('/update-profile/{student}', [WebStudentController::class, 'updateProfile']);
            ...
            Route::get("/payment-history", [PaymentController::class, "studentPaymentHistory"]);
        ...
        Route::group(['prefix' => 'curriculum', 'namespace' => 'Curriculum'], function () {
            Route::get('/all', [CurriculumController::class, 'index']);
            ...
            Route::get('/{curriculum}/topics', [CurriculumController::class, 'topics']);
            Route::post('/topic/{curriculum}', [CurriculumController::class, 'addTopic']);
            Route::put('/topic/{curriculum}/{topic}', [CurriculumController::class, 'updateTopic']);
            Route::delete('/topic/{topic}', [CurriculumController::class, 'deleteTopic']);
            
            Route::get("/{curriculum}/topics/{topic}/questions", [CurriculumController::class, 'questions']);
            Route::post("/{curriculum}/topics/generate", [TeacherController::class, 'generateTopicQuestions']);
            
            Route::post("/{curriculum}/topics/save-questions", [TeacherController::class, 'storeGeneratedQuestions']);
            Route::post("/{curriculum}/topics/save-question", [TeacherController::class, 'storeSingleQuestion']);
            Route::get("/{curriculum}/topics/{topic}/attempts", [TeacherController::class, 'topicAttempts']);
            Route::put("/{curriculum}/questions/{question}", [TeacherController::class, 'updateQuestion']);
            Route::delete("/{curriculum}/questions/{question}", [TeacherController::class, 'destroyQuestion']);
            
            Route::get("/notify/{topic}", [CurriculumController::class, 'notify']);

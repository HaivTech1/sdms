        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <?php $term_setting = termSetting(term('id'), period('id')); ?>
                    <div class="mb-4">
                        <?php if($term_setting && $term_setting->resumption_date && $term_setting->vacation_date): ?>
                            <div class="d-flex justify-content-between align-items-center p-3 border rounded">
                                <div>
                                    <strong>Term resumption:</strong> <?php echo e($term_setting->resumption_date->format('Y-m-d')); ?>

                                    &nbsp;&nbsp;
                                    <strong>Vacation:</strong> <?php echo e($term_setting->vacation_date->format('Y-m-d')); ?>
                    ...
                    <div id="weeks-wrap" data-list-url="<?php echo e(route('admin.week.list')); ?>">
                        <?php echo $__env->make('admin.weeks._weeks_list', ['weeks' => $weeks], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                                ...
                                <form id="editHairstyleForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="d-flex gap-3 mb-2 align-items-center">
                                            <div>
                                                <img id="hairstyle_preview_front" src="<?php echo e(asset("noImage.png")); ?>" alt="front" style="max-width:80px; max-height:80px; object-fit:cover; border:1px solid #ddd; padding:2px; background:#fff;" />
                                            </div>
                                            <div>
                                                <img id="hairstyle_preview_side" src="<?php echo e(asset("noImage.png")); ?>" alt="side" style="max-width:80px; max-height:80px; object-fit:cover; border:1px solid #ddd; padding:2px; background:#fff;" />
                                            </div>
                                            <div>
                                                <img id="hairstyle_preview_back" src="<?php echo e(asset("noImage.png")); ?>" alt="back" style="max-width:80px; max-height:80px; object-fit:cover; border:1px solid #ddd; padding:2px; background:#fff;" />
                                            </div>
                                        </div>
                ...
                <?php $__env->startSection('scripts'); ?>
                        ...
                        (function($){
                            ...
                            $('#generateFromTerm').on('click', function(e){
                                ...
                                $.post("<?php echo e(route('admin.week.store')); ?>", {_token: '<?php echo e(csrf_token()); ?>'})
                            ...
                            $('#manualWeekForm').on('submit', function(e){
                                ...
                                toggleAble($btn, true, 'Generating...');
                                $.post("<?php echo e(route('admin.week.store')); ?>", $form.serialize())
                                    .done(function(res){ toggleAble($btn, false); Swal.fire('Done', res.message || 'Weeks created', 'success'); loadWeeks(listUrl); })
                                    .fail(function(xhr){ toggleAble($btn, false); Swal.fire('Error', xhr.responseJSON?.message || 'Failed to create weeks', 'error'); });
                            });
                            ...
                            $wrap.on('click', '.edit-week', function(e){
                                ...
                                $.get("<?php echo e(route('admin.hairstyle.all')); ?>").done(function(res){
                                    if(res.status && res.data){
                                        ...
                                        $('#hairstyle_preview_front').attr('src', sel.data('front') || '<?php echo e(asset("noImage.png")); ?>');
                                        $('#hairstyle_preview_side').attr('src', sel.data('side') || '<?php echo e(asset("noImage.png")); ?>');
                                        $('#hairstyle_preview_back').attr('src', sel.data('back') || '<?php echo e(asset("noImage.png")); ?>');

                                        // update preview on change
                                        $sel.off('change.preview').on('change.preview', function(){
                                            const s = $(this).find('option:selected');
                                            $('#hairstyle_preview_front').attr('src', s.data('front') || '<?php echo e(asset("noImage.png")); ?>');
                                            $('#hairstyle_preview_side').attr('src', s.data('side') || '<?php echo e(asset("noImage.png")); ?>');
                                            $('#hairstyle_preview_back').attr('src', s.data('back') || '<?php echo e(asset("noImage.png")); ?>');
                                        });
                                    } else {
                                        $('#hairstyle_select').html('<option value="">-- None --</option>');
                                        $('#hairstyle_preview_front').attr('src', '<?php echo e(asset("noImage.png")); ?>');
                                        $('#hairstyle_preview_side').attr('src', '<?php echo e(asset("noImage.png")); ?>');
                                        $('#hairstyle_preview_back').attr('src', '<?php echo e(asset("noImage.png")); ?>');
                                    }
                                }).fail(function(){ 
                                    $('#hairstyle_select').html('<option value="">-- None --</option>');
                                    $('#hairstyle_preview_front').attr('src', '<?php echo e(asset("noImage.png")); ?>');
                            ...
                            $('#editHairstyleForm').on('submit', function(e){
                                ...
                                $.ajax({ url: "<?php echo e(url('/admin/week')); ?>/" + weekId, method: 'PUT', data: { hairstyle_id: hairId, _token: '<?php echo e(csrf_token()); ?>' } })
...
<?php endif; ?><?php /**PATH C:\laragon\www\primary\resources\views\admin\weeks\index.blade.php ENDPATH**/ ?>
<table class="table table-striped">
    ...
    <tbody>
        <?php $__empty_3 = true; $__currentLoopData = $topics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_3 = false; ?>
            <tr data-id="<?php echo e($topic->id); ?>">
                ...
                <td class="topic-questions">
                    ...
                    <a href="<?php echo e(route('curriculum.topics.questions', [$curriculum, $topic])); ?>">Questions (<?php echo e($count); ?>)</a>
                </td>
                <td>
...
<?php /**PATH C:\laragon\www\primary\resources\views\teacher\curriculum\_topics_list.blade.php ENDPATH**/ ?>
...
<html>
<head>
    <?php $__env->startSection('title', "Debtors List"); ?>
    <style>
        #body_content {
            position: relative;
            background: #fff;
                    ...
                    <tbody>
                        <?php $__currentLoopData = $debtors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $debtor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr style="padding: 4px; text-align: left">
                                ...
                                <td style="padding: 3px; text-align: left" data-column="Name"><?php echo e($debtor['student_name']); ?></td>
                                <td style="padding: 3px; text-align: left" data-column="Class"><?php echo e($debtor['class']); ?></td>
                                <td style="padding: 3px; text-align: left" data-column="Outstanding"><?php echo e(number_format($debtor['outstanding']['outstanding'], 2)); ?></td>
                                <td></td>
                            </tr>
...
<?php /**PATH C:\laragon\www\primary\resources\views\generate\debtor_list.blade.php ENDPATH**/ ?>
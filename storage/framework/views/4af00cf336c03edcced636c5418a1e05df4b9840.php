...
<?php $__env->startSection('title', application('name')." | Class"); ?>
                                ...
                                <div class="col-lg-4" id="gradeSearchWrap" style="display:none;">
                                    <div class="search-box me-2 mb-2 d-inline-block">
                                        <div class="position-relative">
                                            <input id="gradeSearchInput" type="text" class="form-control" placeholder="Search grades..." value="<?php echo e(request('search') ?? ''); ?>">
                                ...
                                <table class="table align-middle table-nowrap table-check">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check font-size-16">
                                                        <input class="form-check-input grade-checkbox" value="<?php echo e($grade->id()); ?>"
                                                            type="checkbox" id="grade_<?php echo e($grade->id()); ?>"
                                                            name="selected[]">
                                                    <label class="form-check-label"
                                                        for="<?php echo e($grade->id()); ?>"></label>
                                                </div>
                                            </td>
                                            <td>
...
?>
                                            ...
                                            <td>
                                             ...
                                             <td>
                                                 <?php echo e($grade->subjects->count()); ?>

                                             </td>
                                             <td>
                                                <span class="badge bg-<?php echo e($grade->status ? 'success' : 'danger'); ?>">
                                                    <?php echo e($grade->status ? 'Active' : 'Inactive'); ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" name="subjects[]"
                                                            class="subject-checkbox" value="<?php echo e($subject->id()); ?>" />
                                                    </td>
        ...
        <script>
            $(document).ready(function() {
                ...
                $(document).on('submit', '#gradeForm', function(e) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('grade.store')); ?>",
                        data
                    }).done((res) => {
...
<?php endif; ?><?php /**PATH C:\laragon\www\primary\resources\views\admin\grade\index.blade.php ENDPATH**/ ?>
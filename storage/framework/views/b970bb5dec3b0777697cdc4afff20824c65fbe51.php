...
$terms = \App\Models\Term::all();
    ...
    <script>
        $('#fetchResultForm').on('submit', function(e){
            ...
            // Store data for class PDF button
            $('#generateClassExamPDF').data('period', period);
            $('#generateClassExamPDF').data('term', term);
            ...
            $.ajax({
                ...
                // Show buttons if students have results
                if (students.length > 0) {
                    $('#publishSelected').show();
                    $('#generateClassExamPDF').show();
                } else {
                    $('#publishSelected').hide();
                    $('#generateClassExamPDF').hide();
                }
    ...
    <script>
        ...
        // Generate Class Exam PDF button click handler
        $('#generateClassExamPDF').on('click', function(){
            var button = $(this);
            var period_id = $(this).data('period');
            var term_id = $(this).data('term');
            var grade_id = $(this).data('grade');
            ...
            if (!period_id || !term_id || !grade_id) {
                toastr.warning('Please select class, session, and term first', 'Missing Information');
                return;
            }

...
} elseif ($_instance->childHasBeenRendered('nzbfdJC')) {
    $componentId = $_instance->getRenderedChildComponentId('nzbfdJC');
    $componentTag = $_instance->getRenderedChildComponentTagName('nzbfdJC');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nzbfdJC');
} else {
    $response = \Livewire\Livewire::mount('components.student.result.midterm', ['user' => ''.e($user->id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('nzbfdJC', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

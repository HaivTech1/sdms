...
} elseif ($_instance->childHasBeenRendered('DIEHThP')) {
    $componentId = $_instance->getRenderedChildComponentId('DIEHThP');
    $componentTag = $_instance->getRenderedChildComponentTagName('DIEHThP');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DIEHThP');
} else {
    $response = \Livewire\Livewire::mount('components.admin.result.check-primary', []);
    $html = $response->html();
    $_instance->logRenderedChild('DIEHThP', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

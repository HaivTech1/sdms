...
<?php $component->withAttributes([]); ?>
    ...
    <script src="<?php echo e(asset('js/joystick.js')); ?>"></script>
                ...
                <div id="asidebar">
                    ...
                    <div style="display: flex; justify-content: center">
                        <div style="width: 128px; position: relative">
                            <img
                                src="<?php echo e(URL::asset('images/joystick-base.png')); ?>" />
                            <div id="stick" style="position: absolute; left: 32px; top: 32px">
                                <img
                                    src="<?php echo e(URL::asset('images/joystick-red.png')); ?>" />
                            </div>
                        </div>
                    </div>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\primary\resources\views\manager\user\certificate.blade.php ENDPATH**/ ?>
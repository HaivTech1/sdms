<audio id="myAudio">
    <source src="<?php echo e(asset('sound/notification.mp3')); ?>" type="audio/mpeg">
</audio>
...
<!-- Bootstrap rating js -->
<script src="<?php echo e(asset('libs/bootstrap-rating/bootstrap-rating.min.js')); ?>"></script>

<script src="<?php echo e(asset('js/pages/rating-init.js')); ?>"></script>
...
<script src="<?php echo e(asset('libs/fullcalendar/core/main.min.js')); ?>"></script>
<script src="<?php echo e(asset('libs/fullcalendar/bootstrap/main.min.js')); ?>"></script>
<script src="<?php echo e(asset('libs/fullcalendar/daygrid/main.min.js')); ?>"></script>
<script src="<?php echo e(asset('libs/fullcalendar/timegrid/main.min.js')); ?>"></script>
<script src="<?php echo e(asset('libs/fullcalendar/interaction/main.min.js')); ?>"></script>
...
} elseif ($_instance->childHasBeenRendered('luk7Jq7')) {
    $componentId = $_instance->getRenderedChildComponentId('luk7Jq7');
    $componentTag = $_instance->getRenderedChildComponentTagName('luk7Jq7');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('luk7Jq7');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-spotlight');
    $html = $response->html();
    $_instance->logRenderedChild('luk7Jq7', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php echo $__env->yieldContent('scripts'); ?>
<?php /**PATH C:\laragon\www\primary\resources\views\partials\script.blade.php ENDPATH**/ ?>
                        ...
                        <div class='col-sm-12'>
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap table-check">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $payslips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $payslip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <tr>
                                            <td>
                                                <?php echo e($month); ?> payslips
                                            </td>
                                            <td>
                                                <?php echo e($payslip->count); ?>

                                            </td>
                                            <td>
                                               <?php echo e(trans('global.naira')); ?> <?php echo e(number_format($payslip->total_net, 2)); ?>

                                            </td>
                                            <td>
                                                <button class="btn btn-sm btn-primary review" data-date="<?php echo e($payslip->month_year); ?>">Review</button>
                                            </td>
                                        </tr>
                            ...
                            <?php echo e($payslips->links('pagination::custom-pagination')); ?>
    ...
    <?php $__env->startSection('scripts'); ?>
                    ...
                    success: function(data) {
                       toggleAble(button, false);
                        ...
                        $.each(data, function(key, value) {
                            ...
                            rows += "<td class='text-end'>" + "<?php echo e(trans('global.naira')); ?>" + value.items.net +"</td>";
                        ...
                        rows += "<td class='text-end'>" + "<?php echo e(trans('global.naira')); ?>"+ totalNet.toFixed(2) + "</td>";
                        rows += "<td></td>";
                        rows += "</tr>";
        ...
        <script>
            $('#createSlip').on('submit', function(e){
                ...
                var method = 'POST';
                var url = '<?php echo e(route('payslip.store')); ?>'
...
</div><?php /**PATH C:\laragon\www\primary\resources\views\livewire\components\admin\payslip\index.blade.php ENDPATH**/ ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <div id="rs-banner" class="rs-banner style7">
            <style>
                    ...
                    .rs-banner.style7 {
                        position: relative;
                        background-image: url('<?php echo e(asset("storage/".getAboutSetting("home_banner_image"))); ?>') !important;
            ...
            <style>
                ...
                <div class="content  text-center">
                    <div class="sec-title2 mb-40 ">
                        ...
                        <h2 class="title purple-color">Admission Open for <?php echo e(period('title')); ?></h2>
                        <div class="desc purple-color">
                            <p class="admission-desc"><?php echo e(getAboutSetting('admission_description')); ?></p>
                        </div>
                    </div>
                    <div class="btn-part">
                        <a class="readon purple-color" href="<?php echo e(url('registration')); ?>">Register Now</a>
                    </div>
                </div>
            </div>
        </div>

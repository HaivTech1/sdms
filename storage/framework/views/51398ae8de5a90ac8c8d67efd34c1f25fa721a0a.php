...
} elseif ($_instance->childHasBeenRendered('OYWzbsN')) {
    $componentId = $_instance->getRenderedChildComponentId('OYWzbsN');
    $componentTag = $_instance->getRenderedChildComponentTagName('OYWzbsN');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OYWzbsN');
} else {
    $response = \Livewire\Livewire::mount('components.admin.student.promotion', []);
    $html = $response->html();
    $_instance->logRenderedChild('OYWzbsN', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

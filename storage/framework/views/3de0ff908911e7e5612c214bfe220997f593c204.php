...
} elseif ($_instance->childHasBeenRendered('7MHRrR2')) {
    $componentId = $_instance->getRenderedChildComponentId('7MHRrR2');
    $componentTag = $_instance->getRenderedChildComponentTagName('7MHRrR2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('7MHRrR2');
} else {
    $response = \Livewire\Livewire::mount('components.admin.result.check-primary', []);
    $html = $response->html();
    $_instance->logRenderedChild('7MHRrR2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

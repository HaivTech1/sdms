...
} elseif ($_instance->childHasBeenRendered('4SDcTEa')) {
    $componentId = $_instance->getRenderedChildComponentId('4SDcTEa');
    $componentTag = $_instance->getRenderedChildComponentTagName('4SDcTEa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('4SDcTEa');
} else {
    $response = \Livewire\Livewire::mount('components.admin.result.check-primary', []);
    $html = $response->html();
    $_instance->logRenderedChild('4SDcTEa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

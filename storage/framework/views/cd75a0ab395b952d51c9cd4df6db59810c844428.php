...
} elseif ($_instance->childHasBeenRendered('oFNdxlv')) {
    $componentId = $_instance->getRenderedChildComponentId('oFNdxlv');
    $componentTag = $_instance->getRenderedChildComponentTagName('oFNdxlv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('oFNdxlv');
} else {
    $response = \Livewire\Livewire::mount('components.student.cart-counter', []);
    $html = $response->html();
    $_instance->logRenderedChild('oFNdxlv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

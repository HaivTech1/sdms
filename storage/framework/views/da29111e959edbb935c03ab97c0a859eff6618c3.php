                                        ...
                                        <div class="mb-3">
                                            <select class="form-control block w-full mt-1 select2-multiple" name="to[]"
                                                ...
                                                <optgroup label="Select guardian">
                                                    ...
                                                    <option value="<?php echo e($guardian->phoneNumber()); ?>"><?php echo e($guardian->fullName()); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </optgroup>
                                            </select>
                                        </div>
...
<?php endif; ?>
                                ...
                                <div class="mt-3">
                                    <textarea id="textarea" class="form-control" maxlength="200" rows="3" name="message"
                                                placeholder="Your message has a limit of 200 words." value="<?php echo e(old('message')); ?>"></textarea>
                                </div>
...
<?php endif; ?><?php /**PATH C:\laragon\www\primary\resources\views\admin\messaging\sms.blade.php ENDPATH**/ ?>
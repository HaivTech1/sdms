...
} elseif ($_instance->childHasBeenRendered('cxHklm1')) {
    $componentId = $_instance->getRenderedChildComponentId('cxHklm1');
    $componentTag = $_instance->getRenderedChildComponentTagName('cxHklm1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cxHklm1');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-spotlight');
    $html = $response->html();
    $_instance->logRenderedChild('cxHklm1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

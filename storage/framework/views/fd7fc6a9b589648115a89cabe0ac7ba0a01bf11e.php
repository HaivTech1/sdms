...
} elseif ($_instance->childHasBeenRendered('q2a4jqO')) {
    $componentId = $_instance->getRenderedChildComponentId('q2a4jqO');
    $componentTag = $_instance->getRenderedChildComponentTagName('q2a4jqO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('q2a4jqO');
} else {
    $response = \Livewire\Livewire::mount('components.admin.result.broadsheet.grade', []);
    $html = $response->html();
    $_instance->logRenderedChild('q2a4jqO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

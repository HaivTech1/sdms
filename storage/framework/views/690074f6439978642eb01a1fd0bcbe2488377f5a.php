...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('Curriculum Topics')); ?>
    ...
    <div class="container">
        <div class="d-flex justify-content-between mb-3">
            <h3>Topics for: <?php echo e($curriculum->name); ?></h3>
            <div>
        ...
        <div id="topics-wrap" data-list-url="<?php echo e(route('teacher.curriculum.topics', $curriculum)); ?>">
            <?php echo $__env->make('teacher.curriculum._topics_list', ['topics' => $topics], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-body" id="createTopicBody">
                        <?php echo $__env->make('teacher.curriculum._topic_form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            (function($){
                ...
                $('#generateQuestionsForm').on('submit', function(e){
                    ...
                    $.post("<?php echo e(route('teacher.curriculum.topics.generate', $curriculum)); ?>", payload)
                        .done(function(res){
                            ...
                            if (res.status && res.data) {
                                ...
                                $(document).off('click', '#saveAllQuestions').on('click', '#saveAllQuestions', function(){
                                    ...
                                    $.post("<?php echo e(route('teacher.curriculum.topics.save_questions', $curriculum)); ?>", payload)
                                ...
                                $(document).off('click', '.save-question').on('click', '.save-question', function(){
                                    ...
                                    $.post("<?php echo e(route('teacher.curriculum.topics.save_question', $curriculum)); ?>", payload)
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\primary\resources\views/teacher/curriculum/topics.blade.php ENDPATH**/ ?>
...
} elseif ($_instance->childHasBeenRendered('fZ7p2WY')) {
    $componentId = $_instance->getRenderedChildComponentId('fZ7p2WY');
    $componentTag = $_instance->getRenderedChildComponentTagName('fZ7p2WY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('fZ7p2WY');
} else {
    $response = \Livewire\Livewire::mount('components.student.cart-counter', []);
    $html = $response->html();
    $_instance->logRenderedChild('fZ7p2WY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>

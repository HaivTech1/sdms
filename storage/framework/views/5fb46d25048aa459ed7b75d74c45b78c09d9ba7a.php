...
<div class="shorting_pagination">
    ...
    <div class="shorting_pagination_right">
        <ul class="pagination pagination-rounded justify-content-end mb-2">
            ...
            <li class="page-item" wire:click="gotoPage(<?php echo e($page); ?>)"><a class="page-link active"><?php echo e($page); ?></a></li>
            <?php else: ?>
            <li wire:click="gotoPage(<?php echo e($page); ?>)" class="page-item"><a class="page-link"><?php echo e($page); ?></a></li>
            <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\primary\resources\views/vendor/pagination/custom-pagination.blade.php ENDPATH**/ ?>
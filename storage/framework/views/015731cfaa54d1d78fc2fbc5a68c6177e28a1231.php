        ...
        <div class="main_content">
            <div class="header">
                <div class="header-item">
                    <img src="<?php echo e(public_path('storage/' . application('image'))); ?>" width="80" height="80"
                        alt="Profile Image">
                </div>
                <div class="header-item">
                ...
                <div class="header-item">
                    <img src="<?php echo e($student->user->image() ? asset('storage/' . $student->user->image()) : public_path('default.png')); ?>"
                        width="80" height="80" alt="<?php echo e($student->last_name); ?>" style="border-radius: 100%; border: 3px solid #0F28D5;">
                </div>
            </div>
                        ...
                        <tr>
                            <?php $__currentLoopData = $results; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <?php endif; ?>
                                    <?php if($result->entry_1 != null): ?>
                                        <td style="font-size: 10px; font-weight: 500; text-align: center"><?php echo e($result->entry_1); ?>

                                        </td>
                                    <?php endif; ?>
                                    <?php if($result->entry_2 != null): ?>
                                        <td style="font-size: 10px; font-weight: 500; text-align: center"><?php echo e($result->entry_2); ?>

                                        </td>
                                    <?php endif; ?>
                                    <?php if($result->first_test != null): ?>
                                        <td style="font-size: 10px; font-weight: 500; text-align: center"><?php echo e($result->first_test); ?>

                                        </td>
                                    <?php endif; ?>
                                    <?php if($result->class_activity != null): ?>
                                        <td style="font-size: 10px; font-weight: 500; text-align: center">
                                            <?php echo e($result->class_activity); ?></td>
                                    <?php else: ?>
                                        <td style="font-size: 10px; font-weight: 500; text-align: center">-</td>
                                    <?php endif; ?>
                                    <?php if($result->ca != null): ?>
                                        <td style="font-size: 10px; font-weight: 500; text-align: center"><?php echo e($result->ca); ?></td>
                                    <?php else: ?>
                                        <td style="font-size: 10px; font-weight: 500; text-align: center">-</td>
                                    <?php endif; ?>
                                    <?php if($result->project != null): ?>
                                        <td style="font-size: 10px; font-weight: 500; text-align: center"><?php echo e($result->project); ?>

                                        </td>
                                    <?php endif; ?>
                                    <?php if($result->total() != null): ?>
                                        <td style="font-size: 10px; font-weight: 500; text-align: center"><?php echo e($result->total()); ?>

                                        </td>
                                    <?php endif; ?>
                                    <td style="font-size: 10px; font-weight: 500; text-align: center">
                                        <?php echo e(round(divnum($result->total() * 100, 60))); ?></td>
                                </tr>
...
</html><?php /**PATH C:\laragon\www\primary\resources\views\admin\result\primary_midterm_pdf_result.blade.php ENDPATH**/ ?>
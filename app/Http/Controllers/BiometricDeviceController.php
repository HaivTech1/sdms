...
use App\Helper\FingerHelper;

use App\Http\Controllers\Controller;

use App\Http\Requests\StoreFingerDevicesRequest;

use App\Http\Requests\UpdateFingerDevicesRequest;
...
class BiometricDeviceController extends Controller
{
    public function index()
    {
        ...
        return view('admin.finger.index', ['devices' => $devices]);
    }

    public function create()
    {
        return view('admin.finger.create');
    }

    public function store(StoreFingerDevicesRequest $request): RedirectResponse
    {
        ...
        if ($device->connect()) {
            ...
            $notification = array (
                'messege' => 'Biometric Device created successfully!',
                'alert-type' => 'success',
                'button' => 'Okay!',
                'title' => 'Success'
            );
            ...
            $notification = array (
                'messege' => 'Failed connecting to Biometric Device!',
                'alert-type' => 'error',
                'button' => 'Okay!',
                'title' => 'Faled'
            );
        ...
        return redirect()->route('finger_device.index')->with($notification);
    }
    ...
    public function update(UpdateFingerDevicesRequest $request, FingerDevices $fingerDevice): RedirectResponse
    {
